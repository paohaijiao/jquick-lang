...
public class JQuickLangParser extends Parser {
	...
	public static final int
		...
		RULE_methodName = 23, RULE_argumentList = 24, RULE_literal = 25, RULE_importVar = 26, 
		RULE_identifier = 27, RULE_bool = 28, RULE_string = 29, RULE_date = 30, 
		RULE_variables = 31, RULE_short = 32, RULE_int = 33, RULE_float = 34, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"param", "primary", "methodInvocation", "instanceName", "methodName", 
	...
	public final MethodInvocationContext methodInvocation() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1759781554530254912L) != 0)) {
					{
					setState(269);
					argumentList();
					}
	...
	public final ImportVarContext importVar() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_importVar);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(318);
